module.exports = {
    ...
    rules: {
        ...
        // 最后一个 import 语句后，需要有空行
        'padding-line-between-statements': [
            'error',
            { blankLine: 'always', prev: 'import', next: '*' },
            { blankLine: 'any', prev: 'import', next: ['import', 'cjs-import'] },
        ],
        ...
        // 原文：We strongly recommend that you do not use the no-undef lint rule on TypeScript projects. The checks it provides are already provided by TypeScript without the need for configuration - TypeScript just does this significantly better.
        // 翻译：我们强烈建议您不要在 TypeScript 项目上使用 no-undef lint 规则。它提供的检查已经由 TypeScript 提供，无需配置 - TypeScript 只是做得更好。
        'no-undef': 'off',
        // 函数的参数禁止超过3个
        // @warn 警示即可
        'max-params': ['warn', 3],
        ...
        camelcase: [
            ...
            {
                // 允许不是驼峰对的配置s
                allow: ['workorder_install', 'workorder_dismantle', 'workorder_reverse'],
            },
        ],
        // this别名
